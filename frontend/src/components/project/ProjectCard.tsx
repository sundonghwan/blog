      ...
      <div className="p-6">
        <Link to={`/projects/${project.id}`}>
          ...
          {project.githubUrl && (
              ...
              className="flex-1 flex items-center justify-center gap-2 px-3 sm:px-4 py-2.5 sm:py-2 bg-slate-900 dark:bg-slate-700 text-white rounded-lg hover:opacity-90 transition-opacity text-sm font-medium"
              >
          ...
          {project.liveUrl && (
              ...
              rel="noopener noreferrer"
              onClick={(e) => e.stopPropagation()}
              className="flex-1 flex items-center justify-center gap-2 px-3 sm:px-4 py-2.5 sm:py-2 bg-blue-600 text-white rounded-lg hover:opacity-90 transition-opacity text-sm font-medium"
              >
